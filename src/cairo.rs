...
extern {
  fn cairo_create(surface: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_status(self_arg: *mut std::libc::c_void) -> Status;
  fn cairo_save(self_arg: *mut std::libc::c_void);
  fn cairo_restore(self_arg: *mut std::libc::c_void);
  fn cairo_get_target(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_push_group(self_arg: *mut std::libc::c_void);
  fn cairo_push_group_with_content(self_arg: *mut std::libc::c_void, content: surface::content::Content);
  fn cairo_pop_group(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_pop_group_to_source(self_arg: *mut std::libc::c_void);
  fn cairo_get_group_target(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_set_source_rgb(self_arg: *mut std::libc::c_void, red: f64, green: f64, blue: f64);
  fn cairo_set_source_rgba(self_arg: *mut std::libc::c_void, red: f64, green: f64, blue: f64, alpha: f64);
  fn cairo_set_source(self_arg: *mut std::libc::c_void, source: *mut std::libc::c_void);
  fn cairo_set_source_surface(self_arg: *mut std::libc::c_void, surface: *mut std::libc::c_void, x: f64, y: f64);
  fn cairo_get_source(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_set_antialias(self_arg: *mut std::libc::c_void, antialias: antialias::Antialias);
  ...
  fn cairo_get_line_cap(self_arg: *mut std::libc::c_void) -> line_cap::LineCap;
  fn cairo_set_line_join(self_arg: *mut std::libc::c_void, line_join: line_join::LineJoin);
  fn cairo_get_line_join(self_arg: *mut std::libc::c_void) -> line_join::LineJoin;
  fn cairo_set_line_width(self_arg: *mut std::libc::c_void, width: f64);
  fn cairo_get_line_width(self_arg: *mut std::libc::c_void) -> f64;
  fn cairo_set_miter_limit(self_arg: *mut std::libc::c_void, limit: f64);
  fn cairo_get_miter_limit(self_arg: *mut std::libc::c_void) -> f64;
  fn cairo_set_operator(self_arg: *mut std::libc::c_void, operator: operator::Operator);
  fn cairo_get_operator(self_arg: *mut std::libc::c_void) -> operator::Operator;
  fn cairo_set_tolerance(self_arg: *mut std::libc::c_void, tolerance: f64);
  fn cairo_get_tolerance(self_arg: *mut std::libc::c_void) -> f64;
  fn cairo_clip(self_arg: *mut std::libc::c_void);
  fn cairo_clip_preserve(self_arg: *mut std::libc::c_void);
  fn cairo_clip_extents(self_arg: *mut std::libc::c_void, x1: *mut f64, y1: *mut f64, x2: *mut f64, y2: *mut f64);
  fn cairo_in_clip(self_arg: *mut std::libc::c_void, x: f64, y: f64) -> bool;
  fn cairo_reset_clip(self_arg: *mut std::libc::c_void);
  fn cairo_fill(self_arg: *mut std::libc::c_void);
  fn cairo_fill_preserve(self_arg: *mut std::libc::c_void);
  fn cairo_fill_extents(self_arg: *mut std::libc::c_void, x1: *mut f64, y1: *mut f64, x2: *mut f64, y2: *mut f64);
  fn cairo_in_fill(self_arg: *mut std::libc::c_void, x: f64, y: f64) -> bool;
  fn cairo_mask(self_arg: *mut std::libc::c_void, pattern: *mut std::libc::c_void);
  fn cairo_mask_surface(self_arg: *mut std::libc::c_void, surface: *mut std::libc::c_void, surface_x: f64, surface_y: f64);
  fn cairo_paint(self_arg: *mut std::libc::c_void);
  fn cairo_paint_with_alpha(self_arg: *mut std::libc::c_void, alpha: f64);
  fn cairo_stroke(self_arg: *mut std::libc::c_void);
  fn cairo_stroke_preserve(self_arg: *mut std::libc::c_void);
  fn cairo_stroke_extents(self_arg: *mut std::libc::c_void, x1: *mut f64, y1: *mut f64, x2: *mut f64, y2: *mut f64);
  fn cairo_in_stroke(self_arg: *mut std::libc::c_void, x: f64, y: f64) -> bool;
  fn cairo_copy_page(self_arg: *mut std::libc::c_void);
  fn cairo_show_page(self_arg: *mut std::libc::c_void);
  fn cairo_get_reference_count(self_arg: *mut std::libc::c_void) -> std::libc::c_uint;
  fn cairo_copy_path(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_copy_path_flat(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_append_path(self_arg: *mut std::libc::c_void, path: *mut std::libc::c_void);
  fn cairo_has_current_point(self_arg: *mut std::libc::c_void) -> bool;
  fn cairo_get_current_point(self_arg: *mut std::libc::c_void, x: *mut f64, y: *mut f64);
  fn cairo_new_path(self_arg: *mut std::libc::c_void);
  fn cairo_new_sub_path(self_arg: *mut std::libc::c_void);
  fn cairo_close_path(self_arg: *mut std::libc::c_void);
  fn cairo_arc(self_arg: *mut std::libc::c_void, xc: f64, yc: f64, radius: f64, angle1: f64, angle2: f64);
  fn cairo_arc_negative(self_arg: *mut std::libc::c_void, xc: f64, yc: f64, radius: f64, angle1: f64, angle2: f64);
  fn cairo_curve_to(self_arg: *mut std::libc::c_void, x1: f64, y1: f64, x2: f64, y2: f64, x3: f64, y3: f64);
  fn cairo_line_to(self_arg: *mut std::libc::c_void, x: f64, y: f64);
  fn cairo_move_to(self_arg: *mut std::libc::c_void, x: f64, y: f64);
  fn cairo_rectangle(self_arg: *mut std::libc::c_void, x: f64, y: f64, width: f64, height: f64);
  fn cairo_glyph_path(self_arg: *mut std::libc::c_void, glyphs: *font::Glyph, glyphs: std::libc::c_int);
  fn cairo_text_path(self_arg: *mut std::libc::c_void, text_path: *i8);
  fn cairo_rel_curve_to(self_arg: *mut std::libc::c_void, dx1: f64, dy1: f64, dx2: f64, dy2: f64, dx3: f64, dy3: f64);
  fn cairo_rel_line_to(self_arg: *mut std::libc::c_void, dx: f64, dy: f64);
  fn cairo_rel_move_to(self_arg: *mut std::libc::c_void, dx: f64, dy: f64);
  fn cairo_path_extents(self_arg: *mut std::libc::c_void, x1: *mut f64, y1: *mut f64, x2: *mut f64, y2: *mut f64);
  fn cairo_translate(self_arg: *mut std::libc::c_void, tx: f64, ty: f64);
  fn cairo_scale(self_arg: *mut std::libc::c_void, sx: f64, sy: f64);
  fn cairo_rotate(self_arg: *mut std::libc::c_void, angle: f64);
  fn cairo_transform(self_arg: *mut std::libc::c_void, matrix: *matrix::Matrix);
  ...
  fn cairo_get_font_matrix(self_arg: *mut std::libc::c_void, matrix: *mut matrix::Matrix);
  fn cairo_set_font_options(self_arg: *mut std::libc::c_void, options: *mut std::libc::c_void);
  fn cairo_get_font_options(self_arg: *mut std::libc::c_void, options: *mut std::libc::c_void);
  fn cairo_set_font_face(self_arg: *mut std::libc::c_void, font_face: *mut std::libc::c_void);
  fn cairo_get_font_face(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
  fn cairo_set_scaled_font(self_arg: *mut std::libc::c_void, scaled_font: *mut std::libc::c_void);
...
pub mod pattern {
  ...
  extern {
    fn cairo_pattern_add_color_stop_rgb(self_arg: *mut std::libc::c_void, offset: f64, red: f64, green: f64, blue: f64);
    fn cairo_pattern_add_color_stop_rgba(self_arg: *mut std::libc::c_void, offset: f64, red: f64, green: f64, blue: f64, alpha: f64);
    fn cairo_pattern_get_color_stop_count(self_arg: *mut std::libc::c_void, stop_count: *mut std::libc::c_int) -> super::Status;
    fn cairo_pattern_get_color_stop_rgba(self_arg: *mut std::libc::c_void, stop_count: std::libc::c_int, offset: *mut f64, red: *mut f64, green: *mut f64, blue: *mut f64, alpha: *mut f64) -> super::Status;
    fn cairo_pattern_create_rgb(red: f64, green: f64, blue: f64) -> *mut std::libc::c_void;
    fn cairo_pattern_create_rgba(red: f64, green: f64, blue: f64, alpha: f64) -> *mut std::libc::c_void;
    fn cairo_pattern_get_rgba(self_arg: *mut std::libc::c_void, red: *mut f64, green: *mut f64, blue: *mut f64, alpha: *mut f64) -> super::Status;
    fn cairo_pattern_create_for_surface(surface: *mut std::libc::c_void) -> *mut std::libc::c_void;
    fn cairo_pattern_get_surface(self_arg: *mut std::libc::c_void, surface: *mut super::surface::Surface) -> super::Status;
    fn cairo_pattern_create_linear(x0: f64, y0: f64, x1: f64, y1: f64) -> *mut std::libc::c_void;
    fn cairo_pattern_get_linear_points(self_arg: *mut std::libc::c_void, x0: *mut f64, y0: *mut f64, x1: *mut f64, y1: *mut f64) -> super::Status;
    fn cairo_pattern_create_radial(cx0: f64, cy0: f64, radius0: f64, cx1: f64, cy1: f64, radius1: f64) -> *mut std::libc::c_void;
    fn cairo_pattern_get_radial_circles(self_arg: *mut std::libc::c_void, x0: *mut f64, y0: *mut f64, r0: *mut f64, x1: *mut f64, y1: *mut f64, r1: *mut f64) -> super::Status;
    fn cairo_pattern_create_mesh() -> *mut std::libc::c_void;
    fn cairo_mesh_pattern_begin_patch(self_arg: *mut std::libc::c_void);
    fn cairo_mesh_pattern_end_patch(self_arg: *mut std::libc::c_void);
    fn cairo_mesh_pattern_move_to(self_arg: *mut std::libc::c_void, x: f64, y: f64);
    fn cairo_mesh_pattern_line_to(self_arg: *mut std::libc::c_void, x: f64, y: f64);
    fn cairo_mesh_pattern_curve_to(self_arg: *mut std::libc::c_void, x1: f64, y1: f64, x2: f64, y2: f64, x3: f64, y3: f64);
    fn cairo_mesh_pattern_set_control_point(self_arg: *mut std::libc::c_void, point_num: std::libc::c_uint, x: f64, y: f64);
    fn cairo_mesh_pattern_set_corner_color_rgb(self_arg: *mut std::libc::c_void, corner_num: std::libc::c_uint, red: f64, green: f64, blue: f64);
    fn cairo_mesh_pattern_set_corner_color_rgba(self_arg: *mut std::libc::c_void, corner_num: std::libc::c_uint, red: f64, green: f64, blue: f64, alpha: f64);
    fn cairo_mesh_pattern_get_patch_count(self_arg: *mut std::libc::c_void, count: *mut std::libc::c_uint) -> super::Status;
    fn cairo_mesh_pattern_get_path(self_arg: *mut std::libc::c_void, patch_num: std::libc::c_uint) -> *mut std::libc::c_void;
    fn cairo_mesh_pattern_get_control_point(self_arg: *mut std::libc::c_void, patch_num: std::libc::c_uint, pointer_num: std::libc::c_uint, x: *mut f64, y: *mut f64) -> super::Status;
    fn cairo_mesh_pattern_get_corner_color_rgba(self_arg: *mut std::libc::c_void, patch_num: std::libc::c_uint, pointer_num: std::libc::c_uint, red: *mut f64, green: *mut f64, blue: *mut f64, alpha: *mut f64) -> super::Status;
    fn cairo_pattern_status(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_pattern_set_extend(self_arg: *mut std::libc::c_void, extend: extend::Extend);
    fn cairo_pattern_get_extend(self_arg: *mut std::libc::c_void) -> extend::Extend;
    fn cairo_pattern_set_filter(self_arg: *mut std::libc::c_void, filter: filter::Filter);
    fn cairo_pattern_get_filter(self_arg: *mut std::libc::c_void) -> filter::Filter;
    fn cairo_pattern_set_matrix(self_arg: *mut std::libc::c_void, matrix: *mut super::matrix::Matrix);
    fn cairo_pattern_get_matrix(self_arg: *mut std::libc::c_void, matrix: *mut super::matrix::Matrix);
    fn cairo_pattern_get_type(self_arg: *mut std::libc::c_void) -> pattern_type::PatternType;
    fn cairo_pattern_get_reference_count(self_arg: *mut std::libc::c_void) -> std::libc::c_uint;
  }
...
pub mod region {
  ...
  extern {
    fn cairo_region_create() -> *mut std::libc::c_void;
    fn cairo_region_create_rectangle(rectangle: *Rectangle) -> *mut std::libc::c_void;
    fn cairo_region_create_rectangles(rectangles: *Rectangle, rectangles: std::libc::c_int) -> *mut std::libc::c_void;
    fn cairo_region_status(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_region_get_extents(self_arg: *mut std::libc::c_void, extents: *mut Rectangle);
    fn cairo_region_num_rectangles(self_arg: *mut std::libc::c_void) -> std::libc::c_int;
    fn cairo_region_get_rectangle(self_arg: *mut std::libc::c_void, nth: std::libc::c_int, rectangle: *mut Rectangle);
    fn cairo_region_is_empty(self_arg: *mut std::libc::c_void) -> bool;
    fn cairo_region_contains_point(self_arg: *mut std::libc::c_void, x: std::libc::c_int, y: std::libc::c_int) -> bool;
    fn cairo_region_contains_rectangle(self_arg: *mut std::libc::c_void, rectangle: *Rectangle) -> overlap::Overlap;
    fn cairo_region_equal(self_arg: *mut std::libc::c_void, other: *mut std::libc::c_void) -> bool;
    fn cairo_region_translate(self_arg: *mut std::libc::c_void, dx: std::libc::c_int, dy: std::libc::c_int);
    fn cairo_region_intersect_rectangle(self_arg: *mut std::libc::c_void, rectangle: *Rectangle) -> super::Status;
    fn cairo_region_subtract(self_arg: *mut std::libc::c_void, region: *mut std::libc::c_void) -> super::Status;
    fn cairo_region_subtract_rectangle(self_arg: *mut std::libc::c_void, rectangle: *Rectangle) -> super::Status;
    fn cairo_region_union(self_arg: *mut std::libc::c_void, region: *mut std::libc::c_void) -> super::Status;
    fn cairo_region_union_rectangle(self_arg: *mut std::libc::c_void, rectangle: *Rectangle) -> super::Status;
    fn cairo_region_xor(self_arg: *mut std::libc::c_void, region: *mut std::libc::c_void) -> super::Status;
    fn cairo_region_xor_rectangle(self_arg: *mut std::libc::c_void, rectangle: *Rectangle) -> super::Status;
  }
  ...
  pub struct Rectangle {
    x: std::libc::c_int,
    y: std::libc::c_int,
    width: std::libc::c_int,
    height: std::libc::c_int
  }
...
pub mod font {
  ...
  extern {
    fn cairo_font_options_create() -> *mut std::libc::c_void;
    fn cairo_font_options_status(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_font_options_merge(self_arg: *mut std::libc::c_void, other: *mut std::libc::c_void);
    fn cairo_font_options_hash(self_arg: *mut std::libc::c_void) -> std::libc::c_ulong;
    fn cairo_font_options_equal(self_arg: *mut std::libc::c_void, other: *mut std::libc::c_void) -> bool;
    fn cairo_font_options_set_antialias(self_arg: *mut std::libc::c_void, antialias: super::antialias::Antialias);
    fn cairo_font_options_get_antialias(self_arg: *mut std::libc::c_void) -> super::antialias::Antialias;
    fn cairo_font_options_set_subpixel_order(self_arg: *mut std::libc::c_void, subpixel_order: subpixel_order::SubpixelOrder);
    fn cairo_font_options_get_subpixel_order(self_arg: *mut std::libc::c_void) -> subpixel_order::SubpixelOrder;
    fn cairo_font_options_set_hint_style(self_arg: *mut std::libc::c_void, hint_style: hint_style::HintStyle);
    fn cairo_font_options_get_hint_style(self_arg: *mut std::libc::c_void) -> hint_style::HintStyle;
    fn cairo_font_options_set_hint_metrics(self_arg: *mut std::libc::c_void, hint_metrics: hint_metrics::HintMetrics);
    fn cairo_font_options_get_hint_metrics(self_arg: *mut std::libc::c_void) -> hint_metrics::HintMetrics;
  }
  ...
  extern {
    ...
    fn cairo_font_face_get_type(self_arg: *mut std::libc::c_void) -> font_type::FontType;
    fn cairo_font_face_get_reference_count(self_arg: *mut std::libc::c_void) -> std::libc::c_uint;
  }
  ...
  extern {
    fn cairo_scaled_font_create(font_face: *mut std::libc::c_void, font_matrix: *super::matrix::Matrix, ctm: *super::matrix::Matrix, options: *mut std::libc::c_void) -> *mut std::libc::c_void;
    fn cairo_scaled_font_status(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_scaled_font_extents(self_arg: *mut std::libc::c_void, extents: *mut FontExtents);
    fn cairo_scaled_font_text_extents(self_arg: *mut std::libc::c_void, utf8: *i8, extents: *mut TextExtents);
    fn cairo_scaled_font_glyph_extents(self_arg: *mut std::libc::c_void, glyphs: *Glyph, glyphs: std::libc::c_int, extents: *mut TextExtents);
    fn cairo_scaled_font_get_font_face(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
    fn cairo_scaled_font_get_font_options(self_arg: *mut std::libc::c_void, options: *mut FontExtents);
    fn cairo_scaled_font_get_font_matrix(self_arg: *mut std::libc::c_void, font_matrix: *mut super::matrix::Matrix);
    fn cairo_scaled_font_get_ctm(self_arg: *mut std::libc::c_void, ctm: *mut super::matrix::Matrix);
    fn cairo_scaled_font_get_scale_matrix(self_arg: *mut std::libc::c_void, scale_matrix: *mut super::matrix::Matrix);
    fn cairo_scaled_font_get_type(self_arg: *mut std::libc::c_void) -> font_type::FontType;
    fn cairo_scaled_font_get_reference_count(self_arg: *mut std::libc::c_void) -> std::libc::c_uint;
  }
  ...
  pub struct Glyph {
    index: std::libc::c_ulong,
    x: f64,
    y: f64
  }

  pub struct Cluster {
    num_bytes: std::libc::c_int,
    num_glyphs: std::libc::c_int
  }
...
pub mod device {
  ...
  extern {
    fn cairo_device_status(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_device_finish(self_arg: *mut std::libc::c_void);
    fn cairo_device_flush(self_arg: *mut std::libc::c_void);
    fn cairo_device_get_type(self_arg: *mut std::libc::c_void) -> device_type::DeviceType;
    fn cairo_device_get_reference_count(self_arg: *mut std::libc::c_void) -> std::libc::c_uint;
    fn cairo_device_acquire(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_device_release(self_arg: *mut std::libc::c_void);
  }
...
pub mod surface {
  ...
  extern {
    fn cairo_surface_create_similar_image(format: format::Format, width: std::libc::c_int, height: std::libc::c_int) -> *mut std::libc::c_void;
    fn cairo_surface_create_for_rectangle(x: f64, y: f64, width: f64, height: f64) -> *mut std::libc::c_void;
    fn cairo_surface_status(self_arg: *mut std::libc::c_void) -> super::Status;
    fn cairo_surface_finish(self_arg: *mut std::libc::c_void);
    fn cairo_surface_flush(self_arg: *mut std::libc::c_void);
    fn cairo_surface_get_device(self_arg: *mut std::libc::c_void) -> *mut std::libc::c_void;
    fn cairo_surface_get_font_options(self_arg: *mut std::libc::c_void, options: *mut std::libc::c_void);
    fn cairo_surface_get_content(self_arg: *mut std::libc::c_void) -> content::Content;
    fn cairo_surface_mark_dirty(self_arg: *mut std::libc::c_void);
    fn cairo_surface_mark_dirty_rectangle(self_arg: *mut std::libc::c_void, x: f64, y: f64, width: f64, height: f64);
    fn cairo_surface_set_device_offset(self_arg: *mut std::libc::c_void, x_offset: f64, y_offset: f64);
    fn cairo_surface_get_device_offset(self_arg: *mut std::libc::c_void, x_offset: *mut f64, y_offset: *mut f64);
    fn cairo_surface_set_fallback_resolution(self_arg: *mut std::libc::c_void, x_pixels_per_inch: f64, y_pixels_per_inch: f64);
    fn cairo_surface_get_fallback_resolution(self_arg: *mut std::libc::c_void, x_pixels_per_inch: *mut f64, y_pixels_per_inch: *mut f64);
    fn cairo_surface_get_type(self_arg: *mut std::libc::c_void) -> surface_type::SurfaceType;
    fn cairo_surface_get_reference_count(self_arg: *mut std::libc::c_void) -> std::libc::c_uint;
    fn cairo_surface_copy_page(self_arg: *mut std::libc::c_void);
    fn cairo_surface_show_page(self_arg: *mut std::libc::c_void);
    fn cairo_image_surface_create(format: format::Format, width: std::libc::c_int, height: std::libc::c_int) -> *mut std::libc::c_void;
    fn cairo_image_surface_get_format(self_arg: *mut std::libc::c_void) -> format::Format;
    fn cairo_image_surface_get_width(self_arg: *mut std::libc::c_void) -> std::libc::c_int;
    fn cairo_image_surface_get_height(self_arg: *mut std::libc::c_void) -> std::libc::c_int;
    fn cairo_image_surface_get_stride(self_arg: *mut std::libc::c_void) -> std::libc::c_int;
    fn cairo_image_surface_create_from_png(filename: *i8) -> *mut std::libc::c_void;
...
pub mod matrix {
  ...
  extern {
    ...
    fn cairo_matrix_transform_distance(self_arg: *Matrix, dx: *mut f64, dy: *mut f64);
    fn cairo_matrix_transform_point(self_arg: *Matrix, x: *mut f64, y: *mut f64);
